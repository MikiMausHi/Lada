...
import { recordBreadcrumbs } from "../../../core/utils/testData";
  ...
  render() {
    ...
    if (this.state.section && this.state.felial && this.state.doctor) {
      ...
      if (this.state.calendarEvents.length === 0) {
        ...
        this.state.calendarEvents[0].title === "Новая запись"
      ) {
        this.setState({
          calendarEvents: [...this.state.calendarEvents, ...PostEventsItems]
        });
      }
